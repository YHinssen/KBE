...
class Wingbox(Base):
    ...
    def innersolid(self):
        ...
        return RuledSolid(profiles=self.crosssections[3:])
    @Part
    ...
    def outerskin(self):
        ...
        return RuledSolid(profiles=self.skin_crosssections)
    ...
    def thiccouterskin(self):
        ...
        proffile = []
        y = 0
        for k in range(5):#len(self.thiccness_data)+1):
            ponts = []
            y0 = y
    ...
    @Part
    def test1(self):
        return Polygon(points=(Point(0,0,0),Point(0,1,0),Point(1,1,0),Point(1,0,0)))

    @Part
    def test2(self):
        return Polygon(points=(Point(0.1, 0.1, 1), Point(0.1, 0.9, 1), Point(0.9, 0.9, 1), Point(0.9, 0.1, 1)))
    @Part
    def test3(self):
        return RuledSolid(profile1=self.test1, profile2=self.test2)
    '''

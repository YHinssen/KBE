...
%     fprintf(fic, '%g %g %g %g %g %g %g %g %g %g %g %g \n', CSTu_kink,CSTl_kink);
%     fclose(fic);
    fic = fopen('CSTs.dat','wt');
    fprintf(fic, '%g %g %g %g %g %g %g %g %g %g %g %g ', CSTu_root,CSTl_root);
    fprintf(fic, '%g %g %g %g %g %g %g %g %g %g %g %g ', CSTu_tip,CSTl_tip);
    fprintf(fic, '%g %g %g %g %g %g %g %g %g %g %g %g', CSTu_kink,CSTl_kink);
    fclose(fic);
